...
trait Anon_AltBucketFieldsGenerationIfGenerationMatch extends js.Object {
...
object Anon_AltBucketFieldsGenerationIfGenerationMatch {
  @scala.inline
  def apply(
  ...
  ): Anon_AltBucketFieldsGenerationIfGenerationMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket, `object` = `object`)
    ...
    __obj.asInstanceOf[Anon_AltBucketFieldsGenerationIfGenerationMatch]
  }
}
