...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "compressible" % "2.0-dt-20180214Z-06563f",
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "0.14.1-3f2f40",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.0-e73c0e",
  "org.scalablytyped" %%% "google-cloud__common" % "0.31.0-645200",
  "org.scalablytyped" %%% "google-cloud__paginator" % "0.1.2-d140ca",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-318ad2",
  ...
  "org.scalablytyped" %%% "xdg-basedir" % "2.0-dt-20180214Z-cc2b6e")
