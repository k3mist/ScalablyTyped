...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.4-06cf49",
  "org.scalablytyped" %%% "apollo-server-env" % "2.2.0-3a467a",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.2.1-ec3e1e",
  "org.scalablytyped" %%% "apollo-server-express" % "2.4.5-7aa95b",
  ...
  "org.scalablytyped" %%% "type-is" % "1.6-dt-20180214Z-e14e6e",
