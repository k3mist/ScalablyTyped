...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Expression, 'type'> ]: ast-types.ast-types/gen/nodes.Expression[P]} */ trait JSXExpressionContainer
  extends ASTNode
...
object JSXExpressionContainer {
  ...
  def apply(
    ...
    `type`: astDashTypesLib.astDashTypesLibStrings.JSXExpressionContainer
