...
trait PrintTemplateProperties extends js.Object {
  /**
    ...
    * @default true
    */
  var attributionVisible: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @default 0
    */
  var outScale: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    * @default true
    */
  var preserveScale: js.UndefOr[scala.Boolean] = js.undefined
  /**
