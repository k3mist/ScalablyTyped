...
trait gamepadGamepadSettingsProperties extends js.Object {
  ...
  /**
    ...
    */
  var mode: js.UndefOr[
    arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.pan | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.zoom
  ] = js.undefined
  /**
    ...
    */
  var tiltDirection: js.UndefOr[
    arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`forward-down` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`forward-up`
  ] = js.undefined
}
