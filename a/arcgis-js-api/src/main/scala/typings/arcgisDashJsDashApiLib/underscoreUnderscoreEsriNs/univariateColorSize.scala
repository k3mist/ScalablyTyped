...
trait univariateColorSize extends js.Object {
  /**
    ...
    *
    */
  def createContinuousRenderer(params: univariateColorSizeCreateContinuousRendererParams): arcgisDashJsDashApiLib.IPromise[univariateColorSizeContinuousRendererResult]
  /**
    ...
    *
    */
  def createVisualVariables(params: univariateColorSizeCreateVisualVariablesParams): arcgisDashJsDashApiLib.IPromise[VisualVariablesResult]
}
