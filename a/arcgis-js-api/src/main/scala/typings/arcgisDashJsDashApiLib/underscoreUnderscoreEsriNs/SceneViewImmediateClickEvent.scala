...
trait SceneViewImmediateClickEvent extends js.Object {
...
object SceneViewImmediateClickEvent {
  @scala.inline
  def apply(
    button: scala.Double,
    ...
    __obj.asInstanceOf[SceneViewImmediateClickEvent]
  }
}
