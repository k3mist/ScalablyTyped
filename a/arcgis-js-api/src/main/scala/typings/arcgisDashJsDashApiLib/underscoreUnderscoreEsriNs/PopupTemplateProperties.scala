...
trait PopupTemplateProperties extends js.Object {
  ...
  var content: js.UndefOr[
    ContentElementContentElementProperties | js.Array[ContentElementContentElementProperties] | java.lang.String | js.Function | arcgisDashJsDashApiLib.IPromise[_]
  ] = js.undefined
  /**
  ...
  /**
    ...
    * @default true
    */
  var lastEditInfoEnabled: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @default false
    */
  var overwriteActions: js.UndefOr[scala.Boolean] = js.undefined
  /**
