...
object antdLibStrings {
  ...
  @js.native
  sealed trait `-moz-isolate` extends js.Object
  ...
  @js.native
  sealed trait `-moz-plaintext` extends js.Object
  ...
  @js.native
  sealed trait `-o-crisp-edges` extends js.Object
  
  @js.native
  sealed trait `-webkit-isolate` extends js.Object
  
  @js.native
  sealed trait `-webkit-optimize-contrast` extends js.Object
  
  @js.native
  sealed trait `-webkit-sticky` extends js.Object
  
  @js.native
  sealed trait `3DOT13DOT5` extends js.Object
  ...
  @js.native
  sealed trait SHOW_CHILD extends js.Object
  ...
  @js.native
  sealed trait `all-petite-caps` extends js.Object
  
  @js.native
  sealed trait `all-small-caps` extends js.Object
  ...
  @js.native
  sealed trait `balance-all` extends js.Object
  ...
  @js.native
  sealed trait `block-axis` extends js.Object
  
  @js.native
  sealed trait `block-end` extends js.Object
  ...
  @js.native
  sealed trait changePanel extends js.Object
  ...
  @js.native
  sealed trait `crisp-edges` extends js.Object
  ...
  @js.native
  sealed trait `ideograph-alpha` extends js.Object
  
  @js.native
  sealed trait `ideograph-numeric` extends js.Object
  
  @js.native
  sealed trait `ideograph-parenthesis` extends js.Object
  
  @js.native
  sealed trait `ideograph-space` extends js.Object
  ...
  @js.native
  sealed trait `jump-next` extends js.Object
  
  @js.native
  sealed trait `jump-prev` extends js.Object
  ...
  @js.native
  sealed trait `margin-box` extends js.Object
  ...
  @js.native
  sealed trait `no-drag` extends js.Object
  ...
  @js.native
  sealed trait `read-write-plaintext-only` extends js.Object
  ...
  @js.native
  sealed trait sideways extends js.Object
  ...
  @js.native
  sealed trait `stretch-to-fit` extends js.Object
  ...
  @js.native
  sealed trait unicase extends js.Object
  ...
  @js.native
  sealed trait `vertical-to-horizontal` extends js.Object
  
  @js.native
  sealed trait `view-box` extends js.Object
  ...
  @scala.inline
  def `3DOT13DOT5`: `3DOT13DOT5` = "3.13.5".asInstanceOf[`3DOT13DOT5`]
  @scala.inline
  ...
  @scala.inline
  def changePanel: changePanel = "changePanel".asInstanceOf[changePanel]
  @scala.inline
  ...
  @scala.inline
  def onSelectAll: onSelectAll = "onSelectAll".asInstanceOf[onSelectAll]
  @scala.inline
  def onSelectInvert: onSelectInvert = "onSelectInvert".asInstanceOf[onSelectInvert]
  @scala.inline
  def onSelectMultiple: onSelectMultiple = "onSelectMultiple".asInstanceOf[onSelectMultiple]
  @scala.inline
