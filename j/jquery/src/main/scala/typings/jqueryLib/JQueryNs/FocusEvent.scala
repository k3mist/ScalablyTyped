...
trait FocusEvent[TDelegateTarget, TData, TCurrentTarget, TTarget] extends FocusEventBase[TDelegateTarget, TData, TCurrentTarget, TTarget] {
  @JSName("type")
  var type_FocusEvent: jqueryLib.jqueryLibStrings.focus
}
...
object FocusEvent {
  ...
  def apply[TDelegateTarget, TData, TCurrentTarget, TTarget](
    ...
    `type`: jqueryLib.jqueryLibStrings.focus,
    view: stdLib.Window,
  ...
  ): FocusEvent[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
    val __obj = js.Dynamic.literal(bubbles = bubbles, cancelable = cancelable, currentTarget = currentTarget.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], delegateTarget = delegateTarget.asInstanceOf[js.Any], detail = detail, eventPhase = eventPhase, isDefaultPrevented = isDefaultPrevented, isImmediatePropagationStopped = isImmediatePropagationStopped, isPropagationStopped = isPropagationStopped, preventDefault = preventDefault, stopImmediatePropagation = stopImmediatePropagation, stopPropagation = stopPropagation, target = target.asInstanceOf[js.Any], timeStamp = timeStamp, `type` = `type`, view = view)
    ...
    __obj.asInstanceOf[FocusEvent[TDelegateTarget, TData, TCurrentTarget, TTarget]]
  }
}
