...
This is the home of Scala.js typings for **100** Javascript libraries,
...
--------------------------------------------------------------------------------
 Scala               167452      8531396       759662      2077795      5693939
 Markdown              5987        60612         1135            0        59477
 JSON                     5           29            0            0           29
 Makefile                 2           35            7            0           28
 HTML                     1            6            0            0            6
--------------------------------------------------------------------------------
 Total               173447      8592078       760804      2077795      5753479
--------------------------------------------------------------------------------
...
```scala
  ...
  addSbtPlugin("org.scalablytyped" % "sbt-scalablytyped" % "201903041137")
```
