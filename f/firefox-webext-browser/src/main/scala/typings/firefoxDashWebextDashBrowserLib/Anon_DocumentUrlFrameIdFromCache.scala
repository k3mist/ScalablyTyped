...
trait Anon_DocumentUrlFrameIdFromCache extends js.Object {
...
object Anon_DocumentUrlFrameIdFromCache {
  @scala.inline
  def apply(
  ...
  ): Anon_DocumentUrlFrameIdFromCache = {
    ...
    __obj.asInstanceOf[Anon_DocumentUrlFrameIdFromCache]
  }
}
