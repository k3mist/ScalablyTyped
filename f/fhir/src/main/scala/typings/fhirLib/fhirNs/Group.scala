...
- fhirLib.fhirNs.Resource because Already inherited */ trait Group extends DomainResource {
  /**
...
object Group {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(actual = actual, `type` = `type`)
