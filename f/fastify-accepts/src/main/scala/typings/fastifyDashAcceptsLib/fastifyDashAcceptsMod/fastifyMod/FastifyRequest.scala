...
object FastifyRequest {
  ...
  def apply[HttpRequest](
    ...
    val __obj = js.Dynamic.literal(accepts = accepts, charset = charset.asInstanceOf[js.Any], charsets = charsets.asInstanceOf[js.Any], encoding = encoding.asInstanceOf[js.Any], encodings = encodings.asInstanceOf[js.Any], language = language.asInstanceOf[js.Any], languages = languages.asInstanceOf[js.Any], `type` = `type`.asInstanceOf[js.Any], types = types.asInstanceOf[js.Any])
