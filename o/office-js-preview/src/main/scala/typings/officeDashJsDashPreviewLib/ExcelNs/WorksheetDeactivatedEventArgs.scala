...
trait WorksheetDeactivatedEventArgs extends js.Object {
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var `type`: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.WorksheetDeactivated
  /**
    *
...
object WorksheetDeactivatedEventArgs {
  @scala.inline
  def apply(
    `type`: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.WorksheetDeactivated,
