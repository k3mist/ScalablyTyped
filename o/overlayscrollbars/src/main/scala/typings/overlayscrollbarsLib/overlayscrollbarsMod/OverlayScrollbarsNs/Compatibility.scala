...
object Compatibility {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(bind = bind, cAF = cAF, inA = inA, isA = isA, mBtn = mBtn, mO = mO, now = now, page = page, prvD = prvD, rAF = rAF, rO = rO, stpP = stpP, `type` = `type`, wH = wH, wW = wW)
