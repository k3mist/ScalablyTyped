...
object ojInputDateEventMap {
  ...
  def apply[SP /* <: ojInputDateSettableProperties */](
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateNs.ojAnimateStart,
