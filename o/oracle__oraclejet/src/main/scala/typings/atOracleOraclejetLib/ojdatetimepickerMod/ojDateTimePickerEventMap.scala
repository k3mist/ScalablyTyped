...
trait ojDateTimePickerEventMap extends ojInputDateTimeEventMap[ojDateTimePickerSettableProperties] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojDateTimePickerEventMap: atOracleOraclejetLib.ojdatetimepickerMod.ojDateTimePickerNs.ojAnimateEnd
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojDateTimePickerEventMap: atOracleOraclejetLib.ojdatetimepickerMod.ojDateTimePickerNs.ojAnimateStart
}
...
object ojDateTimePickerEventMap {
  ...
  def apply(
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojdatetimepickerMod.ojDateTimePickerNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojdatetimepickerMod.ojDateTimePickerNs.ojAnimateStart,
