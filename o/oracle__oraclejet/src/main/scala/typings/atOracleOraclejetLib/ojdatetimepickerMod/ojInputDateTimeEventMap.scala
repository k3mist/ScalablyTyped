...
trait ojInputDateTimeEventMap[SP /* <: ojInputDateTimeSettableProperties */] extends ojInputDateEventMap[SP] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputDateTimeEventMap: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateTimeNs.ojAnimateEnd
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputDateTimeEventMap: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateTimeNs.ojAnimateStart
...
object ojInputDateTimeEventMap {
  @scala.inline
  def apply[SP /* <: ojInputDateTimeSettableProperties */](
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateTimeNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojdatetimepickerMod.ojInputDateTimeNs.ojAnimateStart,
