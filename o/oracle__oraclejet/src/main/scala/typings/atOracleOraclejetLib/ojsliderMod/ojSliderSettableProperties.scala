...
object ojSliderSettableProperties {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(disabled = disabled, displayOptions = displayOptions, help = help, helpHints = helpHints, labelHint = labelHint, messagesCustom = messagesCustom, orientation = orientation.asInstanceOf[js.Any], transientValue = transientValue, translations = translations, `type` = `type`.asInstanceOf[js.Any], valid = valid.asInstanceOf[js.Any])
