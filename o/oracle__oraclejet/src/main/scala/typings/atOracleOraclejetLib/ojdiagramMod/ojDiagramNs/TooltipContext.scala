...
object TooltipContext {
  ...
  def apply[K1, K2, D1, D2](
    ...
    val __obj = js.Dynamic.literal(componentElement = componentElement, data = data.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], itemData = itemData.asInstanceOf[js.Any], label = label, parentElement = parentElement, `type` = `type`)
