...
trait Nest[Datum, RollupType] extends js.Object {
  ...
  /**
    ...
    */
  def key(func: js.Function1[/* datum */ Datum, java.lang.String]): this.type
  /**
  ...
  /**
    ...
    */
  def sortKeys(comparator: js.Function2[/* a */ java.lang.String, /* b */ java.lang.String, scala.Double]): this.type
  /**
...
object Nest {
  ...
  def apply[Datum, RollupType](
    ...
    val __obj = js.Dynamic.literal(entries = entries, key = key, map = map, `object` = `object`, rollup = rollup, sortKeys = sortKeys, sortValues = sortValues)
