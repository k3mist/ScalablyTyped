...
object FormatSpecifier {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any], comma = comma, fill = fill, sign = sign.asInstanceOf[js.Any], symbol = symbol.asInstanceOf[js.Any], toString = toString, trim = trim, `type` = `type`.asInstanceOf[js.Any], zero = zero)
