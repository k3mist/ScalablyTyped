...
object BinTransform {
  ...
  def apply(
    ...
    steps: js.Array[scala.Double | vegaDashTypingsLib.typesSpecSignalMod.SignalRef] = null
  ): BinTransform = {
    val __obj = js.Dynamic.literal(extent = extent.asInstanceOf[js.Any], field = field.asInstanceOf[js.Any], `type` = `type`)
