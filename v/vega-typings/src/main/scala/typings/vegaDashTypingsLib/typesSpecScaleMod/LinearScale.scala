...
trait LinearScale
  extends BaseScale
     with Scale {
  var bins: js.UndefOr[scala.Double | vegaDashTypingsLib.typesSpecSignalMod.SignalRef] = js.undefined
...
object LinearScale {
  ...
  def apply(
    ...
    bins: scala.Double | vegaDashTypingsLib.typesSpecSignalMod.SignalRef = null,
    ...
    `type`: vegaDashTypingsLib.vegaDashTypingsLibStrings.linear = null,
