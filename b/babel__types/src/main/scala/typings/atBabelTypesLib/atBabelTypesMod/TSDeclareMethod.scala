...
object TSDeclareMethod {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(async = async, computed = computed, generator = generator, key = key.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], params = params, `type` = `type`)
