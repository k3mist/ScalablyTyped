...
- atBabelTypesLib.atBabelTypesMod._Node because Already inherited */ trait TSTypePredicate
  extends TSType
     with BaseNode {
  var parameterName: Identifier | TSThisType
  var typeAnnotation: TSTypeAnnotation
  @JSName("type")
  var type_TSTypePredicate: atBabelTypesLib.atBabelTypesLibStrings.TSTypePredicate
}
...
object TSTypePredicate {
  ...
  def apply(
    ...
    `type`: atBabelTypesLib.atBabelTypesLibStrings.TSTypePredicate,
