...
object ClassPrivateMethod {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(async = async, body = body, computed = computed, generator = generator, key = key, kind = kind.asInstanceOf[js.Any], params = params, `type` = `type`)
