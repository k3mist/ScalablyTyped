...
object BaseEvent {
  ...
  def apply[T /* <: java.lang.String */, Detail](
    ...
    val __obj = js.Dynamic.literal(currentTarget = currentTarget, detail = detail.asInstanceOf[js.Any], target = target, timeStamp = timeStamp, `type` = `type`.asInstanceOf[js.Any])
