...
object TSDeclareMethod {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(async = async, computed = computed, end = end, generator = generator, key = key, kind = kind.asInstanceOf[js.Any], loc = loc, params = params, start = start, `type` = `type`)
