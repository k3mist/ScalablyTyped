...
trait Config extends js.Object {
  ...
  /**
    ...
    * ```
    */
  var DECIMAL_PLACES: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    * notation.
    */
  var EXPONENTIAL_AT: js.UndefOr[scala.Double | (js.Tuple2[scala.Double, scala.Double])] = js.undefined
  /**
  ...
  /**
    ...
    * ```
    */
  var POW_PRECISION: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var RANGE: js.UndefOr[scala.Double | (js.Tuple2[scala.Double, scala.Double])] = js.undefined
  /**
