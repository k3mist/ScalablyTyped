...
version := "2.0-dt-20181121Z-5596da"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "leaflet_dot_markercluster" % "1.0-dt-20180216Z-a1f222",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-f6f25d",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190226Z-6fcd2f",
  "org.scalablytyped" %%% "react-leaflet" % "2.2-dt-20190226Z-e8ea4e",
