...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "immutability-helper" % "3.0.0-b6b1d3",
  ...
  "org.scalablytyped" %%% "react-motion" % "0.0-unknown-dt-20190212Z-e3f168",
  "org.scalablytyped" %%% "react-multi-ref" % "1.0.0-c826cd",
