...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "json-stringify-safe" % "5.0-dt-20180214Z-4d6007",
  "org.scalablytyped" %%% "lz-string" % "1.3-dt-20190212Z-e10022",
  ...
  "org.scalablytyped" %%% "redux-persist" % "5.10.0-5aa496",
