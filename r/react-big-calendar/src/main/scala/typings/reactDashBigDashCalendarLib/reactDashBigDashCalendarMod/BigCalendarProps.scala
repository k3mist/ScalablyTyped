...
object BigCalendarProps {
  ...
  def apply[TEvent /* <: Event */, TResource /* <: js.Object */](
    ...
    onDoubleClickEvent: (/* event */ TEvent, /* e */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event]) => scala.Unit = null,
    ...
    onSelectEvent: (/* event */ TEvent, /* e */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event]) => scala.Unit = null,
