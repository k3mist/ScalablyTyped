...
version := "2.0-dt-20190212Z-e835da"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material-ui" % "0.21-dt-20190225Z-174f76",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-f6f25d",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190226Z-6fcd2f",
  "org.scalablytyped" %%% "react-addons-linked-state-mixin" % "0.14-dt-20180806Z-95beb5",
