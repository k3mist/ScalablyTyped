...
version := "2.0-dt-20190212Z-761d7a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material-ui" % "0.21-dt-20190225Z-c6c0b1",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-9bad87",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190226Z-e01ec8",
  "org.scalablytyped" %%% "react-addons-linked-state-mixin" % "0.14-dt-20180806Z-a76f31",
