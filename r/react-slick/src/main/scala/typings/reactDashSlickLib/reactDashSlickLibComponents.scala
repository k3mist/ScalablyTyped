...
object reactDashSlickLibComponents {
  @scala.inline
  def ReactDashSlick: reactLib.reactMod.ReactNs.ComponentType[reactDashSlickLib.reactDashSlickMod.Settings] = js.constructorOf[reactDashSlickLib.reactDashSlickMod.default].asInstanceOf
  @scala.inline
