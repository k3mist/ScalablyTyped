...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-date-picker" % "6.0.8-187eb8",
  "org.scalablytyped" %%% "rmc-dialog" % "1.1.1-9461cf",
  "org.scalablytyped" %%% "rmc-feedback" % "2.0.0-ca25f2",
  "org.scalablytyped" %%% "rmc-picker" % "5.0.5-594f0b",
