...
class Linter protected () extends js.Object {
  ...
  def this(options: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ILinterOptions */ js.Any, program: typescriptLib.typescriptMod.tsNs.Program) = this()
