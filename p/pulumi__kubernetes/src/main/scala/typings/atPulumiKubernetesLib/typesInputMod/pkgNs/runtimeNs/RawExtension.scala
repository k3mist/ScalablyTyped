package typings
package atPulumiKubernetesLib.typesInputMod.pkgNs.runtimeNs
...
/**
  ...
  * and stored.)
  */
trait RawExtension extends js.Object {
  /**
...
object RawExtension {
  @scala.inline
  def apply(Raw: atPulumiPulumiLib.resourceMod.Input[java.lang.String]): RawExtension = {
