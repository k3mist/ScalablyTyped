...
version := "4.0.0-dt-20181119Z-cbc92c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-e08349",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-980414",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-b93386",
