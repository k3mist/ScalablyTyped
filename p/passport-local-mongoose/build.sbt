...
version := "4.0.0-dt-20181119Z-075d9a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-6626e2",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-72398c",
