...
trait Anon_AttemptDurationSecondsInput extends js.Object {
  var attemptDurationSeconds: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
}

object Anon_AttemptDurationSecondsInput {
  @scala.inline
  def apply(attemptDurationSeconds: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null): Anon_AttemptDurationSecondsInput = {
