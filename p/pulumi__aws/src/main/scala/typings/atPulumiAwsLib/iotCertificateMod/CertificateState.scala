...
trait CertificateState extends js.Object {
  /**
    ...
    */
  val active: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val csr: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}

object CertificateState {
  @scala.inline
  def apply(
    active: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    arn: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    csr: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): CertificateState = {
