...
trait DocumentationPartArgs extends js.Object {
  /**
    ...
    */
  val location: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_MethodName]
  /**
    * A content map of API-specific key-value pairs describing the targeted API entity. The map must be encoded as a JSON string, e.g., "{ \"description\": \"The API does ...\" }". Only Swagger-compliant key-value pairs can be exported and, hence, published.
    */
  val properties: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
...
object DocumentationPartArgs {
  @scala.inline
  def apply(
    location: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_MethodName],
    properties: atPulumiPulumiLib.resourceMod.Input[java.lang.String],
