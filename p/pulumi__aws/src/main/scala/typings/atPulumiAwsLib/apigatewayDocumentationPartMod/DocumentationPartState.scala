...
object DocumentationPartState {
  @scala.inline
  def apply(
    location: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_MethodName] = null,
    properties: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    restApiId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
