...
trait Anon_StartingPositionInput extends js.Object {
  var startingPosition: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}

object Anon_StartingPositionInput {
  @scala.inline
  def apply(startingPosition: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null): Anon_StartingPositionInput = {
