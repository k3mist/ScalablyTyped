...
trait Anon_OriginAccessIdentityInput extends js.Object {
  var originAccessIdentity: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
}

object Anon_OriginAccessIdentityInput {
  @scala.inline
  def apply(originAccessIdentity: atPulumiPulumiLib.resourceMod.Input[java.lang.String]): Anon_OriginAccessIdentityInput = {
