...
object ConditionalForwaderState {
  @scala.inline
  def apply(
    directoryId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    dnsIps: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[java.lang.String]]] = null,
    remoteDomainName: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
