...
object TaskState {
  ...
  def apply(
    ...
    destinationLocationArn: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.arnMod.ARN] = null,
    name: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    options: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_AtimeBytesPerSecond] = null,
    sourceLocationArn: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.arnMod.ARN] = null,
