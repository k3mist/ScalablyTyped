...
trait HealthCheckState extends js.Object {
  /**
    ...
    */
  val childHealthThreshold: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val cloudwatchAlarmName: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * The CloudWatchRegion that the CloudWatch alarm was created in.
    */
  val cloudwatchAlarmRegion: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * A boolean value that indicates whether Route53 should send the `fqdn` to the endpoint when performing the health check. This defaults to AWS' defaults: when the `type` is "HTTPS" `enable_sni` defaults to `true`, when `type` is anything else `enable_sni` defaults to `false`.
    */
  val enableSni: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  /**
    * The number of consecutive health checks that an endpoint must pass or fail.
    */
  val failureThreshold: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val insufficientDataHealthStatus: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * A boolean value that indicates whether the status of health check should be inverted. For example, if a health check is healthy but Inverted is True , then Route 53 considers the health check to be unhealthy.
    */
  val invertHealthcheck: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val measureLatency: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val requestInterval: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  /**
    * The path that you want Amazon Route 53 to request when performing health checks.
    */
  val resourcePath: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * String searched in the first 5120 bytes of the response body for check to be considered healthy. Only valid with `HTTP_STR_MATCH` and `HTTPS_STR_MATCH`.
    */
  val searchString: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object HealthCheckState {
  @scala.inline
  def apply(
    childHealthThreshold: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
    childHealthchecks: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[java.lang.String]]] = null,
    cloudwatchAlarmName: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    cloudwatchAlarmRegion: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    enableSni: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    failureThreshold: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
    fqdn: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    insufficientDataHealthStatus: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    invertHealthcheck: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    ipAddress: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    measureLatency: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    ...
    requestInterval: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
    resourcePath: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    searchString: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
