...
trait Anon_HttpRouteAnonActionMatch extends js.Object {
  var httpRoute: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[Anon_ActionMatch]] = js.undefined
}

object Anon_HttpRouteAnonActionMatch {
  @scala.inline
  def apply(httpRoute: atPulumiPulumiLib.resourceMod.Input[Anon_ActionMatch] = null): Anon_HttpRouteAnonActionMatch = {
