...
trait RolePolicyState extends js.Object {
  ...
  /**
    ...
    */
  val role: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[java.lang.String | atPulumiAwsLib.iamRoleMod.Role]
  ] = js.undefined
}
...
object RolePolicyState {
  ...
  def apply(
    ...
    role: atPulumiPulumiLib.resourceMod.Input[java.lang.String | atPulumiAwsLib.iamRoleMod.Role] = null
  ): RolePolicyState = {
