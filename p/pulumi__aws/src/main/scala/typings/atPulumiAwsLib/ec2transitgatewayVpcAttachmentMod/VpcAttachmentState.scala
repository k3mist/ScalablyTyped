...
trait VpcAttachmentState extends js.Object {
  ...
  /**
    ...
    */
  val vpcOwnerId: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}
...
object VpcAttachmentState {
  ...
  def apply(
    ...
    vpcOwnerId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): VpcAttachmentState = {
