...
trait MetricAlarmArgs extends js.Object {
  ...
  /**
    ...
    */
  val comparisonOperator: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
  ...
  /**
    ...
    */
  val evaluationPeriods: atPulumiPulumiLib.resourceMod.Input[scala.Double]
  /**
  ...
  /**
    ...
    * See docs for [supported metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html).
    */
  val namespace: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
  ...
  /**
    ...
    */
  val period: atPulumiPulumiLib.resourceMod.Input[scala.Double]
  /**
  ...
  /**
    ...
    */
  val threshold: atPulumiPulumiLib.resourceMod.Input[scala.Double]
  /**
...
object MetricAlarmArgs {
  ...
  def apply(
    ...
    evaluationPeriods: atPulumiPulumiLib.resourceMod.Input[scala.Double],
    ...
    period: atPulumiPulumiLib.resourceMod.Input[scala.Double],
    threshold: atPulumiPulumiLib.resourceMod.Input[scala.Double],
    ...
    val __obj = js.Dynamic.literal(comparisonOperator = comparisonOperator.asInstanceOf[js.Any], evaluationPeriods = evaluationPeriods.asInstanceOf[js.Any], metricName = metricName.asInstanceOf[js.Any], namespace = namespace.asInstanceOf[js.Any], period = period.asInstanceOf[js.Any], threshold = threshold.asInstanceOf[js.Any])
