...
trait LifecycleHookState extends js.Object {
  ...
  /**
    ...
    */
  val lifecycleTransition: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object LifecycleHookState {
  ...
  def apply(
    ...
    lifecycleTransition: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
