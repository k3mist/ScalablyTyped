...
trait CapacityReservationState extends js.Object {
  ...
  val instancePlatform: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.ec2InstancePlatformMod.InstancePlatform]
  ] = js.undefined
  /**
...
object CapacityReservationState {
  ...
  def apply(
    ...
    instancePlatform: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.ec2InstancePlatformMod.InstancePlatform] = null,
