...
object OriginAccessIdentityState {
  ...
  def apply(
    ...
    cloudfrontAccessIdentityPath: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    ...
    iamArn: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    s3CanonicalUserId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
