...
trait MemcachedLayerArgs extends js.Object {
  /**
    * Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
    */
  val allocatedMemory: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  /**
...
object MemcachedLayerArgs {
  ...
  def apply(
    ...
    allocatedMemory: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
