...
trait Anon_ClientIdProviderName extends js.Object {
  ...
  var providerName: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  var serverSideTokenCheck: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
}
...
object Anon_ClientIdProviderName {
  ...
  def apply(
    ...
    serverSideTokenCheck: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null
