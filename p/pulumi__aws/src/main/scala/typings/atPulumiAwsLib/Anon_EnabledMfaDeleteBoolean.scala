...
trait Anon_EnabledMfaDeleteBoolean extends js.Object {
  ...
  var mfaDelete: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
}
...
object Anon_EnabledMfaDeleteBoolean {
  ...
  def apply(
    ...
    mfaDelete: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null
