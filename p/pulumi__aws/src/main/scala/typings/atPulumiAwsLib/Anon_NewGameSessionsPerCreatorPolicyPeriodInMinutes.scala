...
trait Anon_NewGameSessionsPerCreatorPolicyPeriodInMinutes extends js.Object {
  var newGameSessionsPerCreator: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  var policyPeriodInMinutes: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
}

object Anon_NewGameSessionsPerCreatorPolicyPeriodInMinutes {
  @scala.inline
  def apply(
    newGameSessionsPerCreator: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
    policyPeriodInMinutes: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null
