...
trait MainRouteTableAssociationState extends js.Object {
  /**
    ...
    */
  val originalRouteTableId: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object MainRouteTableAssociationState {
  @scala.inline
  def apply(
    originalRouteTableId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
