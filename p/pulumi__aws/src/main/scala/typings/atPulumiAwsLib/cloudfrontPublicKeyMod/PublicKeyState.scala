...
trait PublicKeyState extends js.Object {
  ...
  /**
    ...
    */
  val encodedKey: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object PublicKeyState {
  ...
  def apply(
    ...
    encodedKey: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
