...
trait Anon_MaxConcurrentRunsInput extends js.Object {
  var maxConcurrentRuns: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
}

object Anon_MaxConcurrentRunsInput {
  @scala.inline
  def apply(maxConcurrentRuns: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null): Anon_MaxConcurrentRunsInput = {
