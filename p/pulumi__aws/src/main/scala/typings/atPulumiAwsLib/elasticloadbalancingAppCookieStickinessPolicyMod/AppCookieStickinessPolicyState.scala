...
trait AppCookieStickinessPolicyState extends js.Object {
  /**
    ...
    */
  val cookieName: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object AppCookieStickinessPolicyState {
  @scala.inline
  def apply(
    cookieName: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
