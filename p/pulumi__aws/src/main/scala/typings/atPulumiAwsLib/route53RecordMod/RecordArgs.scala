...
object RecordArgs {
  ...
  def apply(
    ...
    aliases: atPulumiPulumiLib.resourceMod.Input[
      js.Array[
        atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_EvaluateTargetHealthName]
      ]
    ] = null,
    allowOverwrite: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    failoverRoutingPolicies: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_TypeInput]]] = null,
    geolocationRoutingPolicies: atPulumiPulumiLib.resourceMod.Input[
      js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_ContinentCountry]]
    ] = null,
    healthCheckId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    latencyRoutingPolicies: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_RegionInput]]] = null,
    multivalueAnswerRoutingPolicy: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    name: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    records: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[java.lang.String]]] = null,
    setIdentifier: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    ttl: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null,
    weightedRoutingPolicies: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_WeightInput]]] = null
  ): RecordArgs = {
    val __obj = js.Dynamic.literal(`type` = `type`.asInstanceOf[js.Any], zoneId = zoneId.asInstanceOf[js.Any])
