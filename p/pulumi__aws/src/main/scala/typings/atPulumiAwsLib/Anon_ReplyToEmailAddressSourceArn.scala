...
trait Anon_ReplyToEmailAddressSourceArn extends js.Object {
  var replyToEmailAddress: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  var sourceArn: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}

object Anon_ReplyToEmailAddressSourceArn {
  @scala.inline
  def apply(
    replyToEmailAddress: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
