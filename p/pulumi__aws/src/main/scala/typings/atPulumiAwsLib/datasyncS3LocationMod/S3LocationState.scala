...
object S3LocationState {
  ...
  def apply(
    ...
    s3BucketArn: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.arnMod.ARN] = null,
    s3Config: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_BucketAccessRoleArnInput] = null,
