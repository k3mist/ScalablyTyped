...
object LogMetricFilterArgs {
  ...
  def apply(
    ...
    metricTransformation: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_DefaultValueName],
    pattern: atPulumiPulumiLib.resourceMod.Input[java.lang.String],
