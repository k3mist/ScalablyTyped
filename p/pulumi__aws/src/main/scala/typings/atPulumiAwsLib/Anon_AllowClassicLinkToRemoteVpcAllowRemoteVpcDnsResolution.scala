...
trait Anon_AllowClassicLinkToRemoteVpcAllowRemoteVpcDnsResolution extends js.Object {
  var allowClassicLinkToRemoteVpc: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  var allowRemoteVpcDnsResolution: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  var allowVpcToRemoteClassicLink: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
}

object Anon_AllowClassicLinkToRemoteVpcAllowRemoteVpcDnsResolution {
  @scala.inline
  def apply(
    allowClassicLinkToRemoteVpc: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    allowRemoteVpcDnsResolution: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    allowVpcToRemoteClassicLink: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null
