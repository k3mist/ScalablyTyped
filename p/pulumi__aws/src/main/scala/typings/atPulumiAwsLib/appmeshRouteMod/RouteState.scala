...
object RouteState {
  ...
  def apply(
    ...
    spec: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_HttpRouteAnonActionMatch] = null,
    virtualRouterName: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): RouteState = {
