...
trait Anon_CpuCreditsInput extends js.Object {
  var cpuCredits: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}

object Anon_CpuCreditsInput {
  @scala.inline
  def apply(cpuCredits: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null): Anon_CpuCreditsInput = {
