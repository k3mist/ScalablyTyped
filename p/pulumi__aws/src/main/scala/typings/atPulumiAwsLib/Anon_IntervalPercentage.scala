...
trait Anon_IntervalPercentage extends js.Object {
  ...
  var percentage: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
}
...
object Anon_IntervalPercentage {
  ...
  def apply(
    ...
    percentage: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null
