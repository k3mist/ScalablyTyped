...
trait Anon_FieldValues extends js.Object {
  ...
  var values: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}
...
object Anon_FieldValues {
  ...
  def apply(
    ...
    values: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): Anon_FieldValues = {
