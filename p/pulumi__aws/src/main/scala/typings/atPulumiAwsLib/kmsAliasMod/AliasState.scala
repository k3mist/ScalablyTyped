...
trait AliasState extends js.Object {
  ...
  /**
    ...
    */
  val targetKeyArn: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * Identifier for the key for which the alias is for, can be either an ARN or key_id.
    */
  val targetKeyId: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}
...
object AliasState {
  ...
  def apply(
    ...
    targetKeyArn: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    targetKeyId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): AliasState = {
