...
object Anon_CapacityReservationPreferenceCapacityReservationTarget {
  @scala.inline
  def apply(
    capacityReservationPreference: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    capacityReservationTarget: atPulumiPulumiLib.resourceMod.Input[Anon_CapacityReservationIdInput] = null
