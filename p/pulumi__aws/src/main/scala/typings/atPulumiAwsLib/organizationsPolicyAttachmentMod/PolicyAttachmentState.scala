...
trait PolicyAttachmentState extends js.Object {
  /**
    ...
    */
  val policyId: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
...
object PolicyAttachmentState {
  @scala.inline
  def apply(
    policyId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
