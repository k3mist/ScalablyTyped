...
trait CustomLayerArgs extends js.Object {
  /**
  ...
  /**
    ...
    */
  val shortName: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
...
object CustomLayerArgs {
  @scala.inline
  def apply(
    shortName: atPulumiPulumiLib.resourceMod.Input[java.lang.String],
