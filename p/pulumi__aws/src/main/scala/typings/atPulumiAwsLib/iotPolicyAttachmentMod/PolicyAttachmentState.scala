...
object PolicyAttachmentState {
  @scala.inline
  def apply(
    policy: atPulumiPulumiLib.resourceMod.Input[java.lang.String | atPulumiAwsLib.iotMod.Policy] = null,
    target: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.arnMod.ARN] = null
