...
object RdsDbInstanceState {
  @scala.inline
  def apply(
    dbPassword: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    dbUser: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    rdsDbInstanceArn: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
