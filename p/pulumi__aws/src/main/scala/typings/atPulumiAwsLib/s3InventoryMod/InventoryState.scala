...
object InventoryState {
  ...
  def apply(
    ...
    destination: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_BucketAnonAccountIdBucketArn] = null,
    ...
    includedObjectVersions: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    ...
    schedule: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_FrequencyInput] = null
  ): InventoryState = {
