...
object EfsLocationState {
  ...
  def apply(
    ...
    ec2Config: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_SecurityGroupArnsSubnetArn] = null,
    efsFileSystemArn: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.arnMod.ARN] = null,
