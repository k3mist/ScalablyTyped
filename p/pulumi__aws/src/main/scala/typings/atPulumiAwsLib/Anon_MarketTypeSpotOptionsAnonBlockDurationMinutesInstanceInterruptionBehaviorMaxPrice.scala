...
trait Anon_MarketTypeSpotOptionsAnonBlockDurationMinutesInstanceInterruptionBehaviorMaxPrice extends js.Object {
  var marketType: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  var spotOptions: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[Anon_BlockDurationMinutesInstanceInterruptionBehaviorMaxPrice]
  ] = js.undefined
}
...
object Anon_MarketTypeSpotOptionsAnonBlockDurationMinutesInstanceInterruptionBehaviorMaxPrice {
  @scala.inline
  def apply(
    marketType: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    spotOptions: atPulumiPulumiLib.resourceMod.Input[Anon_BlockDurationMinutesInstanceInterruptionBehaviorMaxPrice] = null
