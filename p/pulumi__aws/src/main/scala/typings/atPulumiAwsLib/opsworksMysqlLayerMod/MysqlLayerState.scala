...
trait MysqlLayerState extends js.Object {
  /**
...
object MysqlLayerState {
  ...
  def apply(
    ...
    rootPassword: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    rootPasswordOnAllInstances: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    ...
    __obj.asInstanceOf[MysqlLayerState]
  }
}
