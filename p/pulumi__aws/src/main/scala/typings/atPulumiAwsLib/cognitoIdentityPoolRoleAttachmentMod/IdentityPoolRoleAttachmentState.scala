...
object IdentityPoolRoleAttachmentState {
  @scala.inline
  def apply(
    identityPoolId: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    roleMappings: atPulumiPulumiLib.resourceMod.Input[
      js.Array[
        atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_AmbiguousRoleResolutionIdentityProvider]
      ]
    ] = null,
    roles: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_AuthenticatedUnauthenticated] = null
