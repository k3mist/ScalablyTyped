...
trait Anon_AttemptsInput extends js.Object {
  var attempts: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
}

object Anon_AttemptsInput {
  @scala.inline
  def apply(attempts: atPulumiPulumiLib.resourceMod.Input[scala.Double] = null): Anon_AttemptsInput = {
