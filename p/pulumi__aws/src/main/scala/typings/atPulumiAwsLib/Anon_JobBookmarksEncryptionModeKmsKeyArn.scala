...
trait Anon_JobBookmarksEncryptionModeKmsKeyArn extends js.Object {
  var jobBookmarksEncryptionMode: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
...
object Anon_JobBookmarksEncryptionModeKmsKeyArn {
  @scala.inline
  def apply(
    jobBookmarksEncryptionMode: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
