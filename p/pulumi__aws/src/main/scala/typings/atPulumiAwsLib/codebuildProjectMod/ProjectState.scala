...
object ProjectState {
  ...
  def apply(
    ...
    artifacts: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_EncryptionDisabledLocation] = null,
    badgeEnabled: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    badgeUrl: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    ...
    environment: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_CertificateComputeType] = null,
    ...
    source: atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_AuthsBuildspecGitCloneDepthInsecureSsl] = null,
