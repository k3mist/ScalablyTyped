...
object DirectoryState {
  @scala.inline
  def apply(
    accessUrl: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null,
    ...
    dnsIpAddresses: atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[java.lang.String]]] = null,
