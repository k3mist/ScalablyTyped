...
trait DomainState extends js.Object {
  ...
  /**
    ...
    */
  val workflowExecutionRetentionPeriodInDays: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
}
...
object DomainState {
  ...
  def apply(
    ...
    workflowExecutionRetentionPeriodInDays: atPulumiPulumiLib.resourceMod.Input[java.lang.String] = null
  ): DomainState = {
