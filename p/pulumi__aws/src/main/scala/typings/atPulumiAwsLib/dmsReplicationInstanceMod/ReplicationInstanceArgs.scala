...
trait ReplicationInstanceArgs extends js.Object {
  ...
  /**
    ...
    */
  val replicationInstanceClass: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
    * The replication instance identifier. This parameter is stored as a lowercase string.
    */
  val replicationInstanceId: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
