...
trait AmiCopyArgs extends js.Object {
  ...
  /**
    ...
    */
  val sourceAmiId: atPulumiPulumiLib.resourceMod.Input[java.lang.String]
  /**
...
object AmiCopyArgs {
  @scala.inline
  def apply(
    sourceAmiId: atPulumiPulumiLib.resourceMod.Input[java.lang.String],
    sourceAmiRegion: atPulumiPulumiLib.resourceMod.Input[java.lang.String],
