...
trait Anon_ChallengeRequiredOnNewDeviceDeviceOnlyRememberedOnUserPrompt extends js.Object {
  var challengeRequiredOnNewDevice: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
  var deviceOnlyRememberedOnUserPrompt: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Boolean]] = js.undefined
}

object Anon_ChallengeRequiredOnNewDeviceDeviceOnlyRememberedOnUserPrompt {
  @scala.inline
  def apply(
    challengeRequiredOnNewDevice: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null,
    deviceOnlyRememberedOnUserPrompt: atPulumiPulumiLib.resourceMod.Input[scala.Boolean] = null
