...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-b8a648"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-fd9b67",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-d72e89",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-46bd6e",
  "org.scalablytyped" %%% "std" % "3.3-73c9dd",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-f57356",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-a00d0c")
