...
object BlockValue {
  ...
  def apply(
    ...
    `type`: yamlLib.yamlLibStrings.BLOCK_FOLDED | yamlLib.yamlLibStrings.BLOCK_LITERAL,
    ...
    val __obj = js.Dynamic.literal(chomping = chomping.asInstanceOf[js.Any], hasComment = hasComment, hasProps = hasProps, header = header, jsonLike = jsonLike, props = props, `type` = `type`.asInstanceOf[js.Any], valueRangeContainsNewline = valueRangeContainsNewline)
