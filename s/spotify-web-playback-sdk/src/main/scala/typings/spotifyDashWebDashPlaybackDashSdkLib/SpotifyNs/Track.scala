...
object Track {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(album = album, artists = artists, is_playable = is_playable, media_type = media_type.asInstanceOf[js.Any], name = name, `type` = `type`.asInstanceOf[js.Any], uri = uri)
