...
object CheckboxProps {
  ...
  def apply(
    ...
    onChange: (/* event */ reactLib.reactMod.ReactNs.FormEvent[reactLib.HTMLInputElement], /* data */ CheckboxProps) => scala.Unit = null,
    onClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLInputElement, reactLib.NativeMouseEvent], /* data */ CheckboxProps) => scala.Unit = null,
    onMouseDown: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLInputElement, reactLib.NativeMouseEvent], /* data */ CheckboxProps) => scala.Unit = null,
    onMouseUp: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLInputElement, reactLib.NativeMouseEvent], /* data */ CheckboxProps) => scala.Unit = null,
