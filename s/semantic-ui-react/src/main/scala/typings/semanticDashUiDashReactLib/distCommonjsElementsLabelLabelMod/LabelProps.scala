...
object LabelProps {
  ...
  def apply(
    ...
    image: js.Any = null,
    onClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ LabelProps) => scala.Unit = null,
    onRemove: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ LabelProps) => scala.Unit = null,
