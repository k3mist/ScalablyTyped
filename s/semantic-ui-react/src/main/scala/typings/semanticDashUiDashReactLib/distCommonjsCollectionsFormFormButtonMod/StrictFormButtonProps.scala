...
object StrictFormButtonProps {
  ...
  def apply(
    ...
    onClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLButtonElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsElementsButtonButtonMod.ButtonProps) => scala.Unit = null,
