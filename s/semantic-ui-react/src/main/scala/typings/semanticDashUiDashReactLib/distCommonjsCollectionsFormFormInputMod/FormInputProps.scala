...
object FormInputProps {
  ...
  def apply(
    ...
    onChange: (/* event */ reactLib.reactMod.ReactNs.ChangeEvent[reactLib.HTMLInputElement], /* data */ semanticDashUiDashReactLib.distCommonjsElementsInputInputMod.InputOnChangeData) => scala.Unit = null,
