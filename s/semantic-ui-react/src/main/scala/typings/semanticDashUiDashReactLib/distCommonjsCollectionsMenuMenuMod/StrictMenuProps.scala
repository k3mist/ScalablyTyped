...
object StrictMenuProps {
  ...
  def apply(
    ...
    onItemClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLAnchorElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsCollectionsMenuMenuItemMod.MenuItemProps) => scala.Unit = null,
