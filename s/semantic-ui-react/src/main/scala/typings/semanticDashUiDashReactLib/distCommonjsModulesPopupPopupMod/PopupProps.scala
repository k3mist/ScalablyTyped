...
object PopupProps {
  ...
  def apply(
    ...
    onClose: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ PopupProps) => scala.Unit = null,
    onMount: (/* nothing */ scala.Null, /* data */ PopupProps) => scala.Unit = null,
    onOpen: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ PopupProps) => scala.Unit = null,
