...
object StrictModalProps {
  ...
  def apply(
    ...
    onActionClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ ModalProps) => scala.Unit = null,
    onClose: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ ModalProps) => scala.Unit = null,
    onMount: (/* nothing */ scala.Null, /* data */ ModalProps) => scala.Unit = null,
    onOpen: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ ModalProps) => scala.Unit = null,
