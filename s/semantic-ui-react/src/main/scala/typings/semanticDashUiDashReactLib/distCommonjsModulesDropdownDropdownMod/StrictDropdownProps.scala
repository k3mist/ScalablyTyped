...
object StrictDropdownProps {
  ...
  def apply(
    ...
    onAddItem: (/* event */ reactLib.reactMod.ReactNs.KeyboardEvent[reactLib.HTMLElement], /* data */ DropdownProps) => scala.Unit = null,
    onBlur: (/* event */ reactLib.reactMod.ReactNs.KeyboardEvent[reactLib.HTMLElement], /* data */ DropdownProps) => scala.Unit = null,
    onChange: (/* event */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event], /* data */ DropdownProps) => scala.Unit = null,
    onClick: (/* event */ reactLib.reactMod.ReactNs.KeyboardEvent[reactLib.HTMLElement], /* data */ DropdownProps) => scala.Unit = null,
    onClose: (/* event */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event], /* data */ DropdownProps) => scala.Unit = null,
    onFocus: (/* event */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event], /* data */ DropdownProps) => scala.Unit = null,
    ...
    onMouseDown: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ DropdownProps) => scala.Unit = null,
    onOpen: (/* event */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event], /* data */ DropdownProps) => scala.Unit = null,
    onSearchChange: (/* event */ reactLib.reactMod.ReactNs.SyntheticEvent[reactLib.HTMLElement, reactLib.Event], /* data */ DropdownOnSearchChangeData) => scala.Unit = null,
