...
object PaginationItemProps {
  ...
  def apply(
    ...
    onClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLAnchorElement, reactLib.NativeMouseEvent], /* data */ PaginationItemProps) => scala.Unit = null,
    onKeyDown: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLAnchorElement, reactLib.NativeMouseEvent], /* data */ PaginationItemProps) => scala.Unit = null,
