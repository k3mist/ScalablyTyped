...
object FormTextAreaProps {
  ...
  def apply(
    ...
    onChange: (/* event */ reactLib.reactMod.ReactNs.FormEvent[reactLib.HTMLTextAreaElement], /* data */ semanticDashUiDashReactLib.distCommonjsAddonsTextAreaTextAreaMod.TextAreaProps) => scala.Unit = null,
    onInput: (/* event */ reactLib.reactMod.ReactNs.FormEvent[reactLib.HTMLTextAreaElement], /* data */ semanticDashUiDashReactLib.distCommonjsAddonsTextAreaTextAreaMod.TextAreaProps) => scala.Unit = null,
