...
object DimmerInnerProps {
  ...
  def apply(
    ...
    onClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLDivElement, reactLib.NativeMouseEvent], /* data */ DimmerInnerProps) => scala.Unit = null,
    onClickOutside: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLDivElement, reactLib.NativeMouseEvent], /* data */ DimmerInnerProps) => scala.Unit = null,
