...
object StrictPortalProps {
  ...
  def apply(
    ...
    onClose: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ PortalProps) => scala.Unit = null,
    onMount: (/* nothing */ scala.Null, /* data */ PortalProps) => scala.Unit = null,
    onOpen: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ PortalProps) => scala.Unit = null,
