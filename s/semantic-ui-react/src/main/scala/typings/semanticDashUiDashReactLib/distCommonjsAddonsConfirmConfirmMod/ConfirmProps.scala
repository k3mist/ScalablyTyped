...
object ConfirmProps {
  ...
  def apply(
    ...
    onActionClick: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsModulesModalModalMod.ModalProps) => scala.Unit = null,
    onCancel: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLAnchorElement, reactLib.NativeMouseEvent], /* data */ ConfirmProps) => scala.Unit = null,
    onClose: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsModulesModalModalMod.ModalProps) => scala.Unit = null,
    onConfirm: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLAnchorElement, reactLib.NativeMouseEvent], /* data */ ConfirmProps) => scala.Unit = null,
    onMount: (/* nothing */ scala.Null, /* data */ semanticDashUiDashReactLib.distCommonjsModulesModalModalMod.ModalProps) => scala.Unit = null,
    onOpen: (/* event */ reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsModulesModalModalMod.ModalProps) => scala.Unit = null,
    ...
    triggerRef: /* node */ reactLib.HTMLElement => scala.Unit = null
  ): ConfirmProps = {
