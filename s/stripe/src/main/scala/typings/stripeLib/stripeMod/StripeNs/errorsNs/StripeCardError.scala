...
trait StripeCardError extends StripeError {
  @JSName("type")
  val type_StripeCardError: stripeLib.stripeLibStrings.StripeCardError
}

object StripeCardError {
  @scala.inline
  def apply(
    ...
    `type`: stripeLib.stripeLibStrings.StripeCardError,
    ...
    __obj.asInstanceOf[StripeCardError]
  }
}
