...
object IReview {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(charge = charge.asInstanceOf[js.Any], created = created, id = id, livemode = livemode, `object` = `object`, open = open, reason = reason.asInstanceOf[js.Any])
