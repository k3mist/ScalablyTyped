...
name := "server"
version := "1.0-dt-20190212Z-5e66fb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "csurf" % "1.9.0-dt-20180214Z-c4cd9e",
  "org.scalablytyped" %%% "express" % "4.16-dt-20190122Z-de2fa5",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20190122Z-512e8c",
  "org.scalablytyped" %%% "express-session" % "1.15-dt-20190212Z-19cf52",
  "org.scalablytyped" %%% "formidable" % "1.0.16-dt-20180409Z-9fea89",
  "org.scalablytyped" %%% "helmet" % "0.0-unknown-dt-20180924Z-81831c",
