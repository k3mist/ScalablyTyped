...
name := "server"
version := "1.0-dt-20190212Z-c7047d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "csurf" % "1.9.0-dt-20180214Z-829797",
  "org.scalablytyped" %%% "express" % "4.16-dt-20190122Z-994326",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20190122Z-19b575",
  "org.scalablytyped" %%% "express-session" % "1.15-dt-20190212Z-c15abc",
  "org.scalablytyped" %%% "formidable" % "1.0.16-dt-20180409Z-341dea",
  "org.scalablytyped" %%% "helmet" % "0.0-unknown-dt-20180924Z-85b178",
