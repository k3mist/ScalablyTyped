...
trait AudioFeaturesObject extends js.Object {
  ...
  var `type`: spotifyDashWebDashApiDashJsLib.spotifyDashWebDashApiDashJsLibStrings.audio_features
...
object AudioFeaturesObject {
  ...
  def apply(
    ...
    `type`: spotifyDashWebDashApiDashJsLib.spotifyDashWebDashApiDashJsLibStrings.audio_features,
