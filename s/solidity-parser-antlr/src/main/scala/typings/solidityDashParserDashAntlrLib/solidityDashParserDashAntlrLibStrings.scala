package typings
package solidityDashParserDashAntlrLib
...
object solidityDashParserDashAntlrLibStrings {
  ...
  @scala.inline
  def AssemblyCall: AssemblyCall = "AssemblyCall".asInstanceOf[AssemblyCall]
  @scala.inline
  ...
  @scala.inline
  def AssemblyItem: AssemblyItem = "AssemblyItem".asInstanceOf[AssemblyItem]
  @scala.inline
  def AssemblyLiteral: AssemblyLiteral = "AssemblyLiteral".asInstanceOf[AssemblyLiteral]
  @scala.inline
  def AssemblyLocalDefinition: AssemblyLocalDefinition = "AssemblyLocalDefinition".asInstanceOf[AssemblyLocalDefinition]
  @scala.inline
  ...
  @scala.inline
  def ElementaryTypeName: ElementaryTypeName = "ElementaryTypeName".asInstanceOf[ElementaryTypeName]
  @scala.inline
  ...
  @scala.inline
  def IdentifierList: IdentifierList = "IdentifierList".asInstanceOf[IdentifierList]
  @scala.inline
  ...
  @scala.inline
  def InlineAssemblyStatement: InlineAssemblyStatement = "InlineAssemblyStatement".asInstanceOf[InlineAssemblyStatement]
  @scala.inline
  ...
  @scala.inline
  def StateMutability: StateMutability = "StateMutability".asInstanceOf[StateMutability]
  @scala.inline
  ...
  @scala.inline
  def SubAssembly: SubAssembly = "SubAssembly".asInstanceOf[SubAssembly]
  @scala.inline
