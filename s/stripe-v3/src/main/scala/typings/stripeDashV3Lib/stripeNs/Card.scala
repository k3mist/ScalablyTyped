...
object Card {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(brand = brand, country = country, dynamic_last4 = dynamic_last4, exp_month = exp_month, exp_year = exp_year, fingerprint = fingerprint, funding = funding, id = id, last4 = last4, metadata = metadata, `object` = `object`)
