...
object NavItemView {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addNavItem = addNavItem, destroyed = destroyed, isCollapsed = isCollapsed, on_destroy = on_destroy, remove = remove, setCollapsed = setCollapsed)
