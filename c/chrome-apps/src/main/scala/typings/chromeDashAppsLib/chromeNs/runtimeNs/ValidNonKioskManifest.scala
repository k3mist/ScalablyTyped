...
trait ValidNonKioskManifest
  extends PartialManifest
     with Manifest {
  var kiosk_enabled: js.UndefOr[chromeDashAppsLib.chromeDashAppsLibNumbers.`false`] = js.undefined
}
...
object ValidNonKioskManifest {
  ...
  def apply(
    ...
    kiosk_enabled: chromeDashAppsLib.chromeDashAppsLibNumbers.`false` = null,
