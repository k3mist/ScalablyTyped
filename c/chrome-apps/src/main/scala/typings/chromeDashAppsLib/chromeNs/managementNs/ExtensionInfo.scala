...
object ExtensionInfo {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(description = description, enabled = enabled, hostPermissions = hostPermissions, id = id, installType = installType.asInstanceOf[js.Any], mayDisable = mayDisable, name = name, offlineEnabled = offlineEnabled, permissions = permissions, shortName = shortName, `type` = `type`, version = version, versionName = versionName)
