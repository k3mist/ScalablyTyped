...
object StandardLonghandPropertiesHyphenFallback {
  ...
  def apply[TLength](
    ...
    `animation-delay`: csstypeLib.GlobalsString | js.Array[csstypeLib.GlobalsString] = null,
    `animation-direction`: AnimationDirectionProperty | js.Array[AnimationDirectionProperty] = null,
    `animation-duration`: csstypeLib.GlobalsString | js.Array[csstypeLib.GlobalsString] = null,
    ...
    `flex-grow`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    `flex-shrink`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    ...
    `scroll-margin-block`: ScrollMarginBlockProperty[TLength] | js.Array[ScrollMarginBlockProperty[TLength]] = null,
    `scroll-margin-block-end`: ScrollMarginBlockEndProperty[TLength] | js.Array[ScrollMarginBlockEndProperty[TLength]] = null,
    `scroll-margin-block-start`: ScrollMarginBlockStartProperty[TLength] | js.Array[ScrollMarginBlockStartProperty[TLength]] = null,
    `scroll-margin-bottom`: ScrollMarginBottomProperty[TLength] | js.Array[ScrollMarginBottomProperty[TLength]] = null,
    `scroll-margin-inline-end`: ScrollMarginInlineEndProperty[TLength] | js.Array[ScrollMarginInlineEndProperty[TLength]] = null,
    `scroll-margin-inline-start`: ScrollMarginInlineStartProperty[TLength] | js.Array[ScrollMarginInlineStartProperty[TLength]] = null,
    `scroll-margin-left`: ScrollMarginLeftProperty[TLength] | js.Array[ScrollMarginLeftProperty[TLength]] = null,
    `scroll-margin-right`: ScrollMarginRightProperty[TLength] | js.Array[ScrollMarginRightProperty[TLength]] = null,
    `scroll-margin-top`: ScrollMarginTopProperty[TLength] | js.Array[ScrollMarginTopProperty[TLength]] = null,
    `scroll-padding`: ScrollPaddingProperty[TLength] | js.Array[ScrollPaddingProperty[TLength]] = null,
    `scroll-padding-block`: ScrollPaddingBlockProperty[TLength] | js.Array[ScrollPaddingBlockProperty[TLength]] = null,
    `scroll-padding-block-end`: ScrollPaddingBlockEndProperty[TLength] | js.Array[ScrollPaddingBlockEndProperty[TLength]] = null,
    `scroll-padding-block-start`: ScrollPaddingBlockStartProperty[TLength] | js.Array[ScrollPaddingBlockStartProperty[TLength]] = null,
    `scroll-padding-bottom`: ScrollPaddingBottomProperty[TLength] | js.Array[ScrollPaddingBottomProperty[TLength]] = null
