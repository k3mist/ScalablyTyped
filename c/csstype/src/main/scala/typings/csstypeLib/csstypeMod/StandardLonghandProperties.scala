...
object StandardLonghandProperties {
  ...
  def apply[TLength](
    ...
    scrollMarginBlock: ScrollMarginBlockProperty[TLength] = null,
    scrollMarginBlockEnd: ScrollMarginBlockEndProperty[TLength] = null,
    scrollMarginBlockStart: ScrollMarginBlockStartProperty[TLength] = null,
    scrollMarginBottom: ScrollMarginBottomProperty[TLength] = null,
    scrollMarginInlineEnd: ScrollMarginInlineEndProperty[TLength] = null,
    scrollMarginInlineStart: ScrollMarginInlineStartProperty[TLength] = null,
    scrollMarginLeft: ScrollMarginLeftProperty[TLength] = null,
    scrollMarginRight: ScrollMarginRightProperty[TLength] = null,
    scrollMarginTop: ScrollMarginTopProperty[TLength] = null,
    scrollPadding: ScrollPaddingProperty[TLength] = null,
    scrollPaddingBlock: ScrollPaddingBlockProperty[TLength] = null,
    scrollPaddingBlockEnd: ScrollPaddingBlockEndProperty[TLength] = null,
    scrollPaddingBlockStart: ScrollPaddingBlockStartProperty[TLength] = null,
    scrollPaddingBottom: ScrollPaddingBottomProperty[TLength] = null
    ...
    if (boxDecorationBreak != null) __obj.updateDynamic("boxDecorationBreak")(boxDecorationBreak)
    ...
    if (colorAdjust != null) __obj.updateDynamic("colorAdjust")(colorAdjust)
    ...
    if (fontOpticalSizing != null) __obj.updateDynamic("fontOpticalSizing")(fontOpticalSizing)
    ...
    if (maskBorderMode != null) __obj.updateDynamic("maskBorderMode")(maskBorderMode)
    ...
    if (mixBlendMode != null) __obj.updateDynamic("mixBlendMode")(mixBlendMode)
    ...
    if (offsetAnchor != null) __obj.updateDynamic("offsetAnchor")(offsetAnchor)
    ...
    if (offsetPosition != null) __obj.updateDynamic("offsetPosition")(offsetPosition)
    ...
    if (overflowClipBox != null) __obj.updateDynamic("overflowClipBox")(overflowClipBox)
    ...
    if (overscrollBehaviorX != null) __obj.updateDynamic("overscrollBehaviorX")(overscrollBehaviorX)
    if (overscrollBehaviorY != null) __obj.updateDynamic("overscrollBehaviorY")(overscrollBehaviorY)
    ...
    if (pageBreakAfter != null) __obj.updateDynamic("pageBreakAfter")(pageBreakAfter)
    if (pageBreakBefore != null) __obj.updateDynamic("pageBreakBefore")(pageBreakBefore)
    if (pageBreakInside != null) __obj.updateDynamic("pageBreakInside")(pageBreakInside)
    ...
    if (perspectiveOrigin != null) __obj.updateDynamic("perspectiveOrigin")(perspectiveOrigin)
    ...
    if (scrollMarginBlock != null) __obj.updateDynamic("scrollMarginBlock")(scrollMarginBlock.asInstanceOf[js.Any])
    if (scrollMarginBlockEnd != null) __obj.updateDynamic("scrollMarginBlockEnd")(scrollMarginBlockEnd.asInstanceOf[js.Any])
    if (scrollMarginBlockStart != null) __obj.updateDynamic("scrollMarginBlockStart")(scrollMarginBlockStart.asInstanceOf[js.Any])
    if (scrollMarginBottom != null) __obj.updateDynamic("scrollMarginBottom")(scrollMarginBottom.asInstanceOf[js.Any])
    if (scrollMarginInlineEnd != null) __obj.updateDynamic("scrollMarginInlineEnd")(scrollMarginInlineEnd.asInstanceOf[js.Any])
    if (scrollMarginInlineStart != null) __obj.updateDynamic("scrollMarginInlineStart")(scrollMarginInlineStart.asInstanceOf[js.Any])
    if (scrollMarginLeft != null) __obj.updateDynamic("scrollMarginLeft")(scrollMarginLeft.asInstanceOf[js.Any])
    if (scrollMarginRight != null) __obj.updateDynamic("scrollMarginRight")(scrollMarginRight.asInstanceOf[js.Any])
    if (scrollMarginTop != null) __obj.updateDynamic("scrollMarginTop")(scrollMarginTop.asInstanceOf[js.Any])
    if (scrollPadding != null) __obj.updateDynamic("scrollPadding")(scrollPadding.asInstanceOf[js.Any])
    if (scrollPaddingBlock != null) __obj.updateDynamic("scrollPaddingBlock")(scrollPaddingBlock.asInstanceOf[js.Any])
    if (scrollPaddingBlockEnd != null) __obj.updateDynamic("scrollPaddingBlockEnd")(scrollPaddingBlockEnd.asInstanceOf[js.Any])
    if (scrollPaddingBlockStart != null) __obj.updateDynamic("scrollPaddingBlockStart")(scrollPaddingBlockStart.asInstanceOf[js.Any])
    if (scrollPaddingBottom != null) __obj.updateDynamic("scrollPaddingBottom")(scrollPaddingBottom.asInstanceOf[js.Any])
