...
name := "koa-joi-router"
version := "5.2-dt-20190209Z-459c4d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20180214Z-1d1997",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190223Z-c11c95",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-4d709a",
  "org.scalablytyped" %%% "node" % "11.9-dt-20190222Z-9b48fa",
  "org.scalablytyped" %%% "qs" % "6.5.0-dt-20180214Z-a85228",
