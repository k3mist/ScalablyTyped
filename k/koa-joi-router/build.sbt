...
name := "koa-joi-router"
version := "5.2-dt-20190209Z-0b16bc"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20180214Z-25aa22",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190223Z-960c3d",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-785d4d",
  "org.scalablytyped" %%% "node" % "11.9-dt-20190222Z-050272",
  "org.scalablytyped" %%% "qs" % "6.5.0-dt-20180214Z-3e2b5c",
